...
namespace ShopApp.DataAccess.Concrete.EfCore
{
    public static class SeedDatabase
    {
        public static void Seed()
        {
            ...
            // Database'e uygulanmamis bekleyen migration sayisina gore
            // test verisi database'e eklenecek
            if (context.Database.GetPendingMigrations().Count() == 0)
            {
                if (context.Categories.Count()==0)
                {
                    // Categories uzerine bir liste eklenir. Liste eklerken
                    // listeyi dizi seklinde gonderip addrange icerisinde aktarabiliriz
